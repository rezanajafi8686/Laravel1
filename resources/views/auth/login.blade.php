...
<body class="bg-light-gray" id="body">
    <div class="container d-flex flex-column justify-content-between vh-100">
                    ...
                    <div class="card-header bg-primary">
                        <div class="app-brand">
                            <a href="/index.html">
                                ...
                                <span class="brand-name">Reza Dashboard</span>
                            </a>
                        </div>
                    </div>
        ...
        <div class="copyright pl-0">
            <p class="text-center">&copy; 2018 Copyright REZA Dashboard by
                <a class="text-primary" href="http://www.reza.com/" target="_blank">REZA</a>.
            </p>
        </div>
    </div>
</body>
